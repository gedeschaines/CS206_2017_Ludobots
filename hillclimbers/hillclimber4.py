...
fig1.suptitle('Hill Climber Four Sensors Project', fontsize=15)
panel1 = fig1.add_subplot(111)
panel1.set_xlabel('Genomes -- Synapse Weights')
panel1.set_ylabel('Fitness')
panel1.set_xlim(xmin, xmax)
panel1.set_ylim(ymin, ymax)
panel1.plot(genomes[:,0], fitness[:,0], '.k', label='w0,4')
panel1.plot(genomes[:,1], fitness[:,0], '.r', label='w1,4')
panel1.plot(genomes[:,2], fitness[:,0], '.b', label='w2,4')
panel1.plot(genomes[:,3], fitness[:,0], '.g', label='w3,4')
panel1.legend(loc='lower left', title='Genomes', frameon=False)
plt.show()
...
fig2.suptitle('Hill Climber Four Sensors Project', fontsize=15)
